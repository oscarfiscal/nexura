...
class EmployeControllerTest extends TestCase
{
    ...
    public function test_edit_employe()
    {
        ...
        $response = $this->get('/empleados/'.$employe->id.'/edit')->assertOk(); //obtiene la ruta clientes/id/edit y verifica que el status sea 200
        $response->assertViewIs('empleados.editar'); //verifica que la vista sea clientes.editar
